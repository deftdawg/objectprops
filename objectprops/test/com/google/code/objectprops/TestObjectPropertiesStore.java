...
public class TestObjectPropertiesStore extends TestCase {
	...
	public void testWriteObjectWithDate() throws ObjectPropertiesStoreException, ParseException {
	...
	public void testWriteObjectWithFile() throws ObjectPropertiesStoreException, ParseException {
	...
	public void testWriteObjectWithURL() throws ObjectPropertiesStoreException, MalformedURLException {
	...
	public void testWriteObjectWithPath() throws ObjectPropertiesStoreException {
		store.writeObject("my.path", "Hello, World!");
		String result = (String) store.readObject("my.path", String.class);
		this.assertEquals("result", "Hello, World!", result);
	}

	public void testWriteObjectWithPathMultipleTimes() throws ObjectPropertiesStoreException {
		store.writeObject("my.path", "Hello, World!");
	...
	public void testWriteObjectWithComplexType() throws ObjectPropertiesStoreException {
		Person p = new Person();
		p.firstname = "Michael";
		p.lastname = "Karneim";
		store.writeObject(p);
	...
	public void testReadObjectWithComplexType() throws ObjectPropertiesStoreException {
	...
	public void testWriteObjectWithPathAndComplexType() throws ObjectPropertiesStoreException {
		Person orig = new Person();
	...
	public void testComplex() throws ObjectPropertiesStoreException {
	...
	public void testReplaceValue() throws ObjectPropertiesStoreException {
		Person orig = new Person();
		orig.firstname = "Donald";
		orig.lastname = "Duck";
	...
	public void testMerge() throws ObjectPropertiesStoreException {
	...
	public void testMerge2() throws ObjectPropertiesStoreException {
		Company b = new Company();
		b.name = "Funny Corp.";
		b.personnel = new Person[10];
		for (int i = 0; i < b.personnel.length; i++) {
